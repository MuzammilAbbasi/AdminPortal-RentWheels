...
export function getDataAgainstCnic(cnic,onSuccess,onFailure){
  console.log(cnic,"Cnic")
  console.log("url",`${config.url.rda}${config.endpoint.backoffice.get}/${cnic}`);
  axios.get(`${config.url.rda}${config.endpoint.backoffice.get}/${cnic}`)
  .then(res => {
    console.log('fetchIps cnic: ', res);
    onSuccess(res.data)
  })
  .catch(error => {
    console.log(error)
