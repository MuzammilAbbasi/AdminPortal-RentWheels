...
import { fetchAccountMaintenance, updateAccountMaintenance } from "./apiCalls"
...
class AccountMaintenance extends Component {
  ...
  componentDidMount(){
    ...
    fetchAccountMaintenance( selectedPageSize, currentPage, orderBy, searchCriteria, this.onFetchSuccess, this.onFetchFailure )
  ...
  handleOnPageChange = ( selectedPage ) => {
    ...
    fetchAccountMaintenance( selectedPageSize, selectedPage, orderBy, searchCriteria, this.onFetchSuccess, this.onFetchFailure )
  };
  ...
  handleOnSort = (orderBy) => {
    ...
    fetchAccountMaintenance(selectedPageSize, 1, orderBy, searchCriteria, this.onFetchSuccess, this.onFetchFailure);
  };
    ...
    <Colxx xxs="12">
        <div className="mb-3">
          <div className="d-flex align-items-center">
            <h1>
              <IntlMessages id="menu.account-maintenance" />
            </h1>
        ...
        <CustomModal
          ...
          formName="edit-account-maintenance"
          modalName="edit-account-maintenance-modal-title"
