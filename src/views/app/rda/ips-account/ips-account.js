...
class IpsAccount extends Component {
  constructor(props) {
    super(props);
  ...
  editHandleSubmit = (updatedItem) => {
    ...
    if (updatedItem) {
      ...
      // api-hit.
      updateIps(updatedIps, this.onUpdateSuccess, this.onUpdateError);
    }
  };
  ...
  columns = [
    ...
    },
    {
      Header: "CNIC",
      id: "cinc",
      accessor: (value) => value?.customerDetails?.cnic,
      width: 150,
      filterable: false,
        ...
        <Colxx xxs="12">
          <div className="mb-3">
            <div className="d-flex align-items-center">
              <h1>
                <IntlMessages id="menu.ips-account" />
              </h1>
          ...
          <CustomModal
            ...
            formName="edit-ips"
            modalName="edit-ips-modal-title"
