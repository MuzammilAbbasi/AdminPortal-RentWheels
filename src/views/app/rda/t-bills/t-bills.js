...
import { fetchTBills, updateTBills } from "./apiCalls"
...
class Tbills extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    fetchTBills(selectedPageSize, currentPage, orderBy, searchCriteria, this.onFetchSuccess, this.onFetchFailure);
  ...
  handleOnPageChange = (selectedPage) => {
    ...
    fetchTBills(selectedPageSize, selectedPage, orderBy, searchCriteria, this.onFetchSuccess, this.onFetchFailure);
  };
  ...
  handleOnSort = (orderBy) => {
    ...
    fetchTBills(selectedPageSize, 1, orderBy, searchCriteria, this.onFetchSuccess, this.onFetchFailure);
  };
  ...
  editHandleSubmit = (updatedItem) => {
    ...
    if (updatedItem) {
      ...
      // api-hit.
      updateTBills(updatedTbills, this.onUpdateSuccess, this.onUpdateError)
    }
      ...
      <>
        ...
        <Colxx xxs="12">
          ...
          <CustomModal
            ...
            formName="edit-tbills"
            modalName="edit-t-bills-modal-title"
