...
const MobileAppTransaction = (props) => {
  const { match } = props;
  ...
  const { dateRange, cnic, fromAccount, toAccount, activity } = initialValue;
  ...
  const handleTab = (e) => {
    ...
    const [startDate, endDate] = dateRange;
    setLoading(true);
    let startingDate = moment(startDate).format("DD-MM-YYYY");
    let endingDate = moment(endDate).format("DD-MM-YYYY");
      ...
      <Colxx xxs="12">
        <div>
          <div className="d-flex align-items-center">
            ...
            >
              <IntlMessages id="menu.mobileAppTransaction" />
            </h1>
                  ...
                  <Row className="container">
                    ...
                    <Colxx sm="4">
                      <FormGroup>
                        ...
                        <InputField
                          value={toAccount}
                          label="To Account / Consumer Number *"
                          type="text"
                          id="toAccount"
                          style={{ borderRadius: "10px", padding: "0.5rem" }}
                          required={true}
...
export default MobileAppTransaction;
