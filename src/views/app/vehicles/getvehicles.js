...
class getvehicles extends Component {
  ...
  columns = [
    ...
    {
        Header: "VehicleModel",
        accessor: "vehicleCategory.model",
        width: 100,
    },
    {
        Header: "VehicleType",
    ...
    },
    {
      Header: "VehicleOwner",
      id: "rent",
      accessor: "vehicleOwner.username",
    //   width: 100,
    },
    {
      Header: "OwnerPhone",
      accessor: "vehicleOwner.phone",
      width: 100,
    },
    // {
  ...
  callAPI() {
    fetch("http://localhost:8000/api/v1/vehicles?page=1&limit=5")
  ...
  pageChange = () => {
    ...
    console.log(this.curr + 1);
    fetch(`http://localhost:8000/api/v1/vehicles?page=${this.curr + 1}&limit=5`)
      .then((response) => response.json())
      .then((data) => {
        this.state.list = [];
        this.setState({
